...
public class CampusMap {
    ...
    public static void main(String[] args) {
        ...
        myMap.addBuilding(new House("Duckett House", "41 Elm St Northampton, MA 01063", 3, true, true));
        myMap.addBuilding(new House("Chase House", "41 Elm St Northampton, MA 01063", 3, true, true));
        myMap.addBuilding(new Building("Smith College Museum of Art", "20 Elm St Northampton, MA 01063", 2));
        myMap.addBuilding(new Building("Dewey Hall", "Neilson Drive Northampton, MA 01063", 2));
        ...
        myMap.addBuilding(new Cafe("Campus Center Cafe", "100 Elm St, MA 01063", 1));
